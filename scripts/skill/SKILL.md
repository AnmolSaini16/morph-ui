---
name: morph-ui
description: Add Morph UI's animated React components and write view transitions with React's <ViewTransition> and the vt-* CSS classes. Use when the user wants a Morph UI component ({{componentNames}}), or wants to animate UI changes in React 19.3+ without an animation library, such as shared-element morphs, list add/remove/reorder, directional slides, number rolls or route transitions in Next.js.
---
